  ...
  */
  ...
  protected:
    ...
    /** vereinigt append_from_file und replace_config_file
      ...
      Arg4: der Praefix, der verwendet werden soll (Eingabe) bzw. der letzte Praefix, der verwendet wurde (Rueckgabe)
      Ret: konnten alle Dateien gelesen und geschrieben werden? */
    bool file_input (const char*, const char*, bool, std::string&) throw (std::bad_alloc);
