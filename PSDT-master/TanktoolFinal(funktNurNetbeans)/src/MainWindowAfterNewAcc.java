...
public class MainWindowAfterNewAcc extends javax.swing.JFrame {
    ...
    private void Update_table(String username){
        ...
        "join CAR\n" +
        "on x.carID=CAR.id\n" +
        "join UserData on x.userid=UserData.id where UserData.username='"+CreateAccount.get_username()+"' ORDER BY x.id DESC";
    ...
    private void initComponents() {
        ...
        delete.setFont(new java.awt.Font("AppleGothic", 0, 11)); // NOI18N
        delete.setIcon(new javax.swing.ImageIcon("/Users/Emre/Desktop/interface.png")); // NOI18N
        ...
        save.setFont(new java.awt.Font("AppleGothic", 0, 11)); // NOI18N
        save.setIcon(new javax.swing.ImageIcon("/Users/Emre/Desktop/save.png")); // NOI18N
        save.setText("Save");
        ...
        refresh.setIcon(new javax.swing.ImageIcon("/Users/Emre/Desktop/refresh.png")); // NOI18N
        ...
        jButton4.setFont(new java.awt.Font("AppleGothic", 0, 11)); // NOI18N
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/bars-chart.png"))); // NOI18N
        ...
        my_cars.setFont(new java.awt.Font("AppleGothic", 0, 11)); // NOI18N
        my_cars.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/automobile.png"))); // NOI18N
  ...
  public int get_userID(String username){
    ...
    private void my_carsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_my_carsActionPerformed
        // TODO add your handling code here:
        close();
        AddNewCarAfterNewAcc s= new AddNewCarAfterNewAcc();
        s.setVisible(true);
