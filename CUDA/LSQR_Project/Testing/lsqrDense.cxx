...
void lsqrDense::SetMatrix( double ** inputA )
{
  this->A = inputA;
}
 ...
 */
void lsqrDense::Aprod1(unsigned int m, unsigned int n, const double * x, double * y ) const
{
 ...
 */
void lsqrDense::Aprod2(unsigned int m, unsigned int n, double * x, const double * y ) const
{
  for ( unsigned int col = 0; col < n; col++ )
    {
    double sum = 0.0;
...
*/
void lsqrDense::HouseholderTransformation(unsigned int n, const double * z, double * x ) const
{
