...
class Data:
    ...
    def __init__(self, x, y, name, mean, cov_unbiased, cov_biased):
        self.x = x
        self.y = y
        self.name = name

        self.mean = mean
        self.cov_unbiased = cov_unbiased
        self.cov_biased = cov_biased
...
def main():
    ...
    densEst1 = Data(x_densEst1, y_densEst1, 'densEst1', np.asarray([-0.45575151, -0.58567544]),
                    np.asarray([[11.32184216, 3.92665659], [3.92665659, 3.70421947]]),
                    np.asarray([[11.08597045, 3.84485124], [3.84485124, 3.62704823]]))
    densEst2 = Data(x_densEst2, y_densEst2, 'densEst2', np.asarray([3.96283462, 4.12475873]),
                    np.asarray([[4.57468033, -0.09674016], [-0.09674016, 2.2481175]]),
                    np.asarray([[4.54458375, -0.09610371], [-0.09610371, 2.23332725]]))
